...
void EMSCRIPTEN_KEEPALIVE emscripten_bind_btCollisionWorld_updateSingleAabb_1(btCollisionWorld* self, btCollisionObject* arg0) {
  self->updateSingleAabb(arg0);
}
...
void EMSCRIPTEN_KEEPALIVE emscripten_bind_btDynamicsWorld_updateSingleAabb_1(btDynamicsWorld* self, btCollisionObject* arg0) {
  self->updateSingleAabb(arg0);
}
...
const float EMSCRIPTEN_KEEPALIVE emscripten_bind_btTypedConstraint_getParam_2(btTypedConstraint* self, int arg0, int arg1) {
  return self->getParam(arg0, arg1);
}

void EMSCRIPTEN_KEEPALIVE emscripten_bind_btTypedConstraint_setParam_3(btTypedConstraint* self, int arg0, float arg1, int arg2) {
...
void EMSCRIPTEN_KEEPALIVE emscripten_bind_btActionInterface_updateAction_2(btActionInterface* self, btCollisionWorld* arg0, float arg1) {
  self->updateAction(arg0, arg1);
}
...
btVector3* EMSCRIPTEN_KEEPALIVE emscripten_bind_btVector3_rotate_2(btVector3* self, btVector3* arg0, float arg1) {
  static btVector3 temp;
  return (temp = self->rotate(*arg0, arg1), &temp);
}
...
void EMSCRIPTEN_KEEPALIVE emscripten_bind_btVehicleRaycaster_castRay_3(btVehicleRaycaster* self, btVector3* arg0, btVector3* arg1, btDefaultVehicleRaycaster::btVehicleRaycasterResult* arg2) {
  self->castRay(*arg0, *arg1, *arg2);
}
...
void EMSCRIPTEN_KEEPALIVE emscripten_bind_btDiscreteDynamicsWorld_updateSingleAabb_1(btDiscreteDynamicsWorld* self, btCollisionObject* arg0) {
  self->updateSingleAabb(arg0);
}
...
const float EMSCRIPTEN_KEEPALIVE emscripten_bind_btGeneric6DofConstraint_getParam_2(btGeneric6DofConstraint* self, int arg0, int arg1) {
  return self->getParam(arg0, arg1);
}

void EMSCRIPTEN_KEEPALIVE emscripten_bind_btGeneric6DofConstraint_setParam_3(btGeneric6DofConstraint* self, int arg0, float arg1, int arg2) {
  self->setParam(arg0, arg1, arg2);
}
...
void EMSCRIPTEN_KEEPALIVE emscripten_bind_btDefaultVehicleRaycaster_castRay_3(btDefaultVehicleRaycaster* self, btVector3* arg0, btVector3* arg1, btDefaultVehicleRaycaster::btVehicleRaycasterResult* arg2) {
  self->castRay(*arg0, *arg1, *arg2);
}
...
void EMSCRIPTEN_KEEPALIVE emscripten_bind_btRigidBody_applyLocalTorque_1(btRigidBody* self, btVector3* arg0) {
  self->applyLocalTorque(*arg0);
}
...
void EMSCRIPTEN_KEEPALIVE emscripten_bind_btRigidBody_applyCentralLocalForce_1(btRigidBody* self, btVector3* arg0) {
  self->applyCentralLocalForce(*arg0);
}
...
void EMSCRIPTEN_KEEPALIVE emscripten_bind_btRigidBody_getAabb_2(btRigidBody* self, btVector3* arg0, btVector3* arg1) {
  self->getAabb(*arg0, *arg1);
}
...
void EMSCRIPTEN_KEEPALIVE emscripten_bind_btRigidBody_setGravity_1(btRigidBody* self, btVector3* arg0) {
  self->setGravity(*arg0);
}
...
const float EMSCRIPTEN_KEEPALIVE emscripten_bind_btConeTwistConstraint_getParam_2(btConeTwistConstraint* self, int arg0, int arg1) {
  return self->getParam(arg0, arg1);
}

void EMSCRIPTEN_KEEPALIVE emscripten_bind_btConeTwistConstraint_setParam_3(btConeTwistConstraint* self, int arg0, float arg1, int arg2) {
  self->setParam(arg0, arg1, arg2);
}
...
const float EMSCRIPTEN_KEEPALIVE emscripten_bind_btHingeConstraint_getParam_2(btHingeConstraint* self, int arg0, int arg1) {
  return self->getParam(arg0, arg1);
}

void EMSCRIPTEN_KEEPALIVE emscripten_bind_btHingeConstraint_setParam_3(btHingeConstraint* self, int arg0, float arg1, int arg2) {
  self->setParam(arg0, arg1, arg2);
}
...
btWheelInfo* EMSCRIPTEN_KEEPALIVE emscripten_bind_btWheelInfo_btWheelInfo_1(btWheelInfoConstructionInfo* arg0) {
  return new btWheelInfo(*arg0);
}
...
void EMSCRIPTEN_KEEPALIVE emscripten_bind_btWheelInfo_updateWheel_2(btWheelInfo* self, btRigidBody* arg0, btWheelInfo::RaycastInfo* arg1) {
  self->updateWheel(*arg0, *arg1);
}
...
btVector3* EMSCRIPTEN_KEEPALIVE emscripten_bind_btVector4_rotate_2(btVector4* self, btVector3* arg0, float arg1) {
  static btVector3 temp;
  return (temp = self->rotate(*arg0, arg1), &temp);
}
...
float EMSCRIPTEN_KEEPALIVE emscripten_bind_btRaycastVehicle_rayCast_1(btRaycastVehicle* self, btWheelInfo* arg0) {
  return self->rayCast(*arg0);
}

void EMSCRIPTEN_KEEPALIVE emscripten_bind_btRaycastVehicle_updateVehicle_1(btRaycastVehicle* self, float arg0) {
  self->updateVehicle(arg0);
}
...
float EMSCRIPTEN_KEEPALIVE emscripten_bind_btRaycastVehicle_getSteeringValue_1(btRaycastVehicle* self, int arg0) {
  return self->getSteeringValue(arg0);
}

void EMSCRIPTEN_KEEPALIVE emscripten_bind_btRaycastVehicle_updateWheelTransformsWS_1(btRaycastVehicle* self, btWheelInfo* arg0) {
  self->updateWheelTransformsWS(*arg0);
}

void EMSCRIPTEN_KEEPALIVE emscripten_bind_btRaycastVehicle_updateWheelTransformsWS_2(btRaycastVehicle* self, btWheelInfo* arg0, bool arg1) {
  self->updateWheelTransformsWS(*arg0, arg1);
}

void EMSCRIPTEN_KEEPALIVE emscripten_bind_btRaycastVehicle_setPitchControl_1(btRaycastVehicle* self, float arg0) {
  self->setPitchControl(arg0);
}

void EMSCRIPTEN_KEEPALIVE emscripten_bind_btRaycastVehicle_updateSuspension_1(btRaycastVehicle* self, float arg0) {
  self->updateSuspension(arg0);
}

void EMSCRIPTEN_KEEPALIVE emscripten_bind_btRaycastVehicle_updateFriction_1(btRaycastVehicle* self, float arg0) {
  self->updateFriction(arg0);
}
...
void EMSCRIPTEN_KEEPALIVE emscripten_bind_btRaycastVehicle_setUserConstraintType_1(btRaycastVehicle* self, int arg0) {
  self->setUserConstraintType(arg0);
}

void EMSCRIPTEN_KEEPALIVE emscripten_bind_btRaycastVehicle_setUserConstraintId_1(btRaycastVehicle* self, int arg0) {
  self->setUserConstraintId(arg0);
}
...
void EMSCRIPTEN_KEEPALIVE emscripten_bind_btRaycastVehicle_updateAction_2(btRaycastVehicle* self, btCollisionWorld* arg0, float arg1) {
  self->updateAction(arg0, arg1);
}
...
void EMSCRIPTEN_KEEPALIVE emscripten_bind_btKinematicCharacterController_updateAction_2(btKinematicCharacterController* self, btCollisionWorld* arg0, float arg1) {
  self->updateAction(arg0, arg1);
}
...
void EMSCRIPTEN_KEEPALIVE emscripten_bind_btSoftRigidDynamicsWorld_updateSingleAabb_1(btSoftRigidDynamicsWorld* self, btCollisionObject* arg0) {
  self->updateSingleAabb(arg0);
}
...
btFixedConstraint* EMSCRIPTEN_KEEPALIVE emscripten_bind_btFixedConstraint_btFixedConstraint_4(btRigidBody* arg0, btRigidBody* arg1, btTransform* arg2, btTransform* arg3) {
  return new btFixedConstraint(*arg0, *arg1, *arg2, *arg3);
}

void EMSCRIPTEN_KEEPALIVE emscripten_bind_btFixedConstraint_enableFeedback_1(btFixedConstraint* self, bool arg0) {
  self->enableFeedback(arg0);
}
...
void EMSCRIPTEN_KEEPALIVE emscripten_bind_btFixedConstraint_setBreakingImpulseThreshold_1(btFixedConstraint* self, float arg0) {
  self->setBreakingImpulseThreshold(arg0);
}

const float EMSCRIPTEN_KEEPALIVE emscripten_bind_btFixedConstraint_getParam_2(btFixedConstraint* self, int arg0, int arg1) {
  return self->getParam(arg0, arg1);
}

void EMSCRIPTEN_KEEPALIVE emscripten_bind_btFixedConstraint_setParam_3(btFixedConstraint* self, int arg0, float arg1, int arg2) {
  self->setParam(arg0, arg1, arg2);
}
...
const float EMSCRIPTEN_KEEPALIVE emscripten_bind_btSliderConstraint_getParam_2(btSliderConstraint* self, int arg0, int arg1) {
  return self->getParam(arg0, arg1);
}

void EMSCRIPTEN_KEEPALIVE emscripten_bind_btSliderConstraint_setParam_3(btSliderConstraint* self, int arg0, float arg1, int arg2) {
  self->setParam(arg0, arg1, arg2);
}
...
const float EMSCRIPTEN_KEEPALIVE emscripten_bind_btPoint2PointConstraint_getParam_2(btPoint2PointConstraint* self, int arg0, int arg1) {
  return self->getParam(arg0, arg1);
}

void EMSCRIPTEN_KEEPALIVE emscripten_bind_btPoint2PointConstraint_setParam_3(btPoint2PointConstraint* self, int arg0, float arg1, int arg2) {
  self->setParam(arg0, arg1, arg2);
}
...
void EMSCRIPTEN_KEEPALIVE emscripten_bind_btQuaternion_setRotation_2(btQuaternion* self, btVector3* arg0, float arg1) {
  self->setRotation(*arg0, arg1);
}
...
float EMSCRIPTEN_KEEPALIVE emscripten_bind_btQuaternion_dot_1(btQuaternion* self, btQuaternion* arg0) {
  return self->dot(*arg0);
}
...
float EMSCRIPTEN_KEEPALIVE emscripten_bind_btQuaternion_angle_1(btQuaternion* self, btQuaternion* arg0) {
  return self->angle(*arg0);
}

float EMSCRIPTEN_KEEPALIVE emscripten_bind_btQuaternion_angleShortestPath_1(btQuaternion* self, btQuaternion* arg0) {
  return self->angleShortestPath(*arg0);
}

btQuaternion* EMSCRIPTEN_KEEPALIVE emscripten_bind_btQuaternion_op_add_1(btQuaternion* self, btQuaternion* arg0) {
  return &(*self += *arg0);
}

btQuaternion* EMSCRIPTEN_KEEPALIVE emscripten_bind_btQuaternion_op_sub_1(btQuaternion* self, btQuaternion* arg0) {
  return &(*self -= *arg0);
}

btQuaternion* EMSCRIPTEN_KEEPALIVE emscripten_bind_btQuaternion_op_mul_1(btQuaternion* self, float arg0) {
  return &(*self *= arg0);
}

btQuaternion* EMSCRIPTEN_KEEPALIVE emscripten_bind_btQuaternion_op_mulq_1(btQuaternion* self, btQuaternion* arg0) {
  return &(*self *= *arg0);
}

btQuaternion* EMSCRIPTEN_KEEPALIVE emscripten_bind_btQuaternion_op_div_1(btQuaternion* self, float arg0) {
  return &(*self /= arg0);
}
...
const float EMSCRIPTEN_KEEPALIVE emscripten_bind_btGeneric6DofSpringConstraint_getParam_2(btGeneric6DofSpringConstraint* self, int arg0, int arg1) {
  return self->getParam(arg0, arg1);
}

void EMSCRIPTEN_KEEPALIVE emscripten_bind_btGeneric6DofSpringConstraint_setParam_3(btGeneric6DofSpringConstraint* self, int arg0, float arg1, int arg2) {
  self->setParam(arg0, arg1, arg2);
}
